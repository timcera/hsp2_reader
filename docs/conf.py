#
# hsp2_reader documentation build configuration file, created by
...
htmlhelp_basename = "hsp2_readerdoc"
...
man_pages = [
    ("index", "hsp2_reader", "hsp2_reader Documentation", ["Tim Cera, P.E."], 1)
]
