...
Report Bugs
~~~~~~~~~~~
Report bugs at https://bitbucket.org/timcera/hsp2_reader/issues?status=new&status=open
...
Submit Feedback
~~~~~~~~~~~~~~~
The best way to send feedback is to file an issue at https://bitbucket.org/timcera/hsp2_reader
...
Get Started!
------------
Ready to contribute? Here's how to set up `hsp2_reader` for local development.

1. Fork the `hsp2_reader` repo on bitbucket at
   https://bitbucket.org/timcera/hsp2_reader/fork.

2. Clone your fork locally::

    $ git clone git@bitbucket.org:your_bitbucket_login/hsp2_reader.git

3. Install your local copy into a virtualenv. Assuming you have
   virtualenvwrapper installed, this is how you set up your fork for local
   development::

    $ mkvirtualenv hsp2_reader
    $ cd hsp2_reader
